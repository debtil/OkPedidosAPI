...
namespace OkPedidos.Core.Services.Interfaces
{
    public interface IUserService
    {
        ...
        Task<Result<CreateUserResponse>> Update(int id, CreateUserRequest request, IdentityUserModel currentUser);
        Task<Result<CreateUserResponse>> Delete(int id, IdentityUserModel currentUser);
